...
<head>
    ...
    <style>
        body {
            background-color: #253529; /* Updated background color to match other tabs */
            color: white;
        }
        ...
        .profile-container {
            max-width: 800px;
            margin: 0 auto;
            background-color: #354f52; /* Dark green tone for profile card */
            padding: 20px;
            border-radius: 10px;
            color: white;
...
<body>
    ...
    <div class="content">
        <div class="profile-container">
            ...
            <p><strong>Role:</strong> <?php echo htmlspecialchars(ucfirst($user['role'])); ?></p> <!-- Role displayed below Full Name -->
    ...
    <div class="modal fade" id="editProfileModal" tabindex="-1" aria-labelledby="editProfileModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="background-color: #253529; color: white;"> <!-- Modal body matches the new background -->
